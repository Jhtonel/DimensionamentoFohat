  ...
  return (
    <div className="h-full w-full p-4 sm:p-6 space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-gray-900">Admin • Formas de Pagamento</h1>
        <div className="flex gap-2">
          <Button onClick={carregarPadrao} disabled={loading} variant="outline">
            Carregar Padrão
          </Button>
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card>
            ...
            <CardContent className="p-4 space-y-4">
              <div className="text-sm text-gray-500 mb-2">
                Configure as taxas de parcelamento no cartão de crédito via PagSeguro.
              </div>
              
              <div className="grid grid-cols-4 gap-2 text-xs font-semibold text-gray-500 pb-2 border-b">
                <div>Parcelas</div>
                <div>Taxa (%)</div>
                <div>Parcela (R$10k)</div>
                <div></div>
              </div>
          ...
          <Card>
            ...
            <CardContent className="p-4 space-y-4">
              <div className="text-sm text-gray-500 mb-2">
                Configure as taxas de financiamento bancário (taxa mensal).
              </div>
              ...
              <div className="space-y-2 max-h-[400px] overflow-y-auto">
                {formasPagamento.financiamento.map((item, index) => {
                  // Cálculo de parcela com juros compostos (Price)
      ...
      <Card>
        <CardHeader>
          <CardTitle>Preview - Como aparecerá na proposta (valor exemplo: R$ 10.000,00)</CardTitle>
        </CardHeader>
        <CardContent>
